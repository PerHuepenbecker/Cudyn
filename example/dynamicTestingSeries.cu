            ...
            for(const auto threadsPerBlock: threadsPerBlockArgs){
                ...
                switch(kernelType){
                        case Cudyn::Scheduler::KernelType::REDUCED_ATOMICS:{
                            Cudyn::Profiling::launchProfiled<Cudyn::Scheduler::ReducedAtomicScheduler>(config, SpMVKernel);
                            break;
                        } default: {
                            Cudyn::Profiling::launchProfiled<Cudyn::Scheduler::StandardScheduler>(config, SpMVKernel);
                        }
